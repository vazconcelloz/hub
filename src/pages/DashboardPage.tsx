...
import { Plus, Search, Eye, Copy, Pencil, FileText, Trash2, ExternalLink } from "lucide-react";
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap gap-2">
            <Button onClick={() => navigate("/app/cotacoes/saude/proposta/nova?modo=manual")} size="lg" variant="outline">
              <Plus className="w-4 h-4 mr-2" />
              Criar do zero
            </Button>
            <Button onClick={() => navigate("/app/cotacoes/saude/proposta/nova")} size="lg">
        ...
        {loading ? (
          ...
          <Card className="p-12 text-center">
            ...
            <div className="mt-4 flex flex-wrap gap-2 justify-center">
              <Button onClick={() => navigate("/app/cotacoes/saude/proposta/nova?modo=manual")} variant="outline">
                <Plus className="w-4 h-4 mr-2" /> Criar do zero
              </Button>
              <Button onClick={() => navigate("/app/cotacoes/saude/proposta/nova")}>
              ...
              <Card key={p.id} className="p-4 hover:shadow-card-hover transition-shadow">
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                  ...
                  <div className="flex items-center gap-1 flex-wrap">
                    <Button variant="ghost" size="icon" onClick={() => navigate(`/app/cotacoes/saude/proposta/${p.id}`)} title="Editar">
                      <Pencil className="w-4 h-4" />
                    </Button>
                    <Button variant="ghost" size="icon" onClick={() => navigate(`/app/cotacoes/saude/cotacao/${p.slug}`)} title="Visualizar/Editar grade">
                      <Eye className="w-4 h-4" />
                    </Button>
                    <Button variant="ghost" size="icon" onClick={() => window.open(`/cotacao/${p.slug}?tracking=false`, '_blank')} title="Ver como cliente">
